...
?>
		<?php $selected_class = $value === $field['value'] ? ' selected' : '';?>
		<label class="<?php echo $is_image ? 'bs-has-image' . $selected_class : ''; ?>" for="<?php echo $clean_id; // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped -- Escaped above.?>">
		<?php
        if ($is_image) :
